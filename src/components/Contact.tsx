          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-navy font-medium">[Your University/Institute], [City, State]</p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-navy font-medium">[Your Phone Number]</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <div className="flex space-x-4">
              {[
                ...
                { name: "Google Scholar", url: "https://scholar.google.com", icon: "M5.242 13.769L0 9.5 12 0l12 9.5-5.242 4.269C17.548 11.249 14.978 9.5 12 9.5c-2.977 0-5.548 1.748-6.758 4.269zM12 10a7 7 0 1 0 0 14 7 7 0 0 0 0-14z" }
              ].map((social, index) => (
                <a 
                  key={index}
                  href={social.url} 
